...
public class Solution {
    ...
    static int formingMagicSquare(int[][] s) {
        //magic constant has to be 15
        //there's actually only 8 solutions to a 3x3 magic square
        //5 in the middle, pairs across from one another that equal 10 on opposite sides of the 5int 
